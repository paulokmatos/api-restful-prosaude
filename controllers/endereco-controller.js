...
exports.getCidade = async (req, res, next) => {
    try {
...
exports.getBairro = async (req, res, next) => {
    try {
        await mysql.getConnection((error, conn) => {
            if (error) { return res.status(500).send({ error: error }) }
            conn.query(
...
exports.getPais = async (req, res, next) => {
    try {
        await mysql.getConnection((error, conn) => {
            if (error) { return res.status(500).send({ error: error }) }
            conn.query(
...
exports.postCidade = async (req, res, next) => {
    try {
        await mysql.getConnection((error, conn) => {
            if (error) { res.status(500).send({ error: error }) }
            conn.query(
...
exports.postBairro = async (req, res, next) => {
    try {
        await mysql.getConnection((error, conn) => {
            if (error) { res.status(500).send({ error: error }) }
            conn.query(
...
exports.postEstado = async (req, res, next) => {
    try {
        await mysql.getConnection((error, conn) => {
            if (error) { res.status(500).send({ error: error }) }
            conn.query(
...
exports.getEnderecoId = async (req, res, next) => {
    try {
        await mysql.getConnection((error, conn) => {
            if (error) { return res.status(500).send({ error: error }) }
            conn.query(
